    ...
    <div className="flex flex-col border-t sm:flex-row gap-1 sm:gap-10 pt-10">
      ...
      <div className="min-w-60">
        ...
        >
          ...
          <div className="flex flex-col gap-2 text-sm font-light text-gray-700">
            ...
            <p className="flex gap-2">
              <input className="w-3" type="checkbox" value={"Dresses"} />
              Dresses
            </p>
            <p className="flex gap-2">
              <input className="w-3" type="checkbox" value={"Sunglasses"} />
              Sunglasses
            </p>
            <p className="flex gap-2">
              <input className="w-3" type="checkbox" value={"Scarves"} />
              Scarves
            </p>
            <p className="flex gap-2">
              <input className="w-3" type="checkbox" value={"Outerwear"} />
              Outerwear
            </p>
          </div>
        </div>
      ...
      <div className="flex-1">
        <div className="flex justify-between text-base sm:text-2xl mb-4">
          ...
          {/* Product Sort */}
          <select className="border-2 text-sm px-2 border-gray-300">
